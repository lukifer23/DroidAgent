...
- The server now tracks OpenClaw on the patched `2026.3.31` release line and pins the nested `@anthropic-ai/sdk` dependency to `0.82.0`, so the production dependency audit stays clean without forking OpenClaw behavior in-repo.
